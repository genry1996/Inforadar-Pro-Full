...
<body>
    ...
    <div class="filters-panel">
        ...
        <div id="corridorFilters" style="display:none;">
            ...
            <span id="corridorWidthValue">5%</span>
        </div>
    ...
    <table class="anomalies-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="anomaly-icon severity-critical" title="LIMIT_CUT">LIMIT_CUT CRITICAL</span></td>
                <td>-45.0%</td>
    ...
    <div class="success-message" style="display:none;">Found 3 anomalies</div>
    ...
    <script>
        ...
        document.getElementById('corridorWidth').addEventListener('input', (e) => {
            document.getElementById('corridorWidthValue').textContent = e.target.value + '%';
        });
