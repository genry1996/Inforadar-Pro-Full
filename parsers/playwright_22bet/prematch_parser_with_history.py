...
Отслеживание истории коэффициентов с индикаторами Alg1 и Alg2
"""
...
class OddsHistoryTracker:
    """Класс для отслеживания истории коэффициентов"""
    ...
    def get_previous_odds(self, eventname, markettype):
        """Получить предыдущие коэффициенты"""
    ...
    def save_odds_snapshot(self, eventname, eventid, markettype, odds_data, matchtime):
        """Сохранить снимок коэффициентов с индикаторами"""
        try:
...
class PrematchParser:
    ...
    async def parse_prematch(self, page):
        ...
        while scroll_iterations < max_iterations:
            ...
            if current_height == previous_height:
                print(f"✅ Scrolled {scroll_iterations} times")
                break
    ...
    def save_to_odds22bet(self, eventname, league, odds_1x2, matchtime):
        """Сохранение в odds22bet для совместимости"""
        try:
            sql = """
            ...
            print(f"❌ Save to odds22bet error: {e}")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            while True:
                ...
                print(f"\n✅ Iteration {iteration} completed: {saved} matches")
